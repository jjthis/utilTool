...
public class ClearEditText extends AppCompatEditText implements TextWatcher, View.OnTouchListener, View.OnFocusChangeListener {
    ...
    private void setClearIconVisible(boolean visible) {
        clearDrawable.setVisible(visible && isUsed, false);
        setCompoundDrawables(null, null, visible && isUsed ? clearDrawable : null, null);
    }

    public static void setUseClearIcon(boolean used){
        isUsed = used;
    }
